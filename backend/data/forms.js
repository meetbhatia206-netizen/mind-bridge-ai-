const forms = {
  aadhaar: {
    ...
    fields: [
      ...
      { 
        ...
        explanation_en: (ans) => { return "Since you are updating, do you want to provide your Enrolment ID (EID) or your 12-digit Aadhaar number?"; }, 
        explanation_hi: (ans) => { return "चूंकि आप अपडेट कर रहे हैं, क्या आप अपना नामांकन आईडी (EID) या अपना 12 अंकों का आधार नंबर देना चाहते हैं?"; },
        type: 'text', validation: 'required', 
      ...
      { 
        ...
        explanation_en: (ans) => { return `Please enter your ${ans.id_type_update || 'ID'} number clearly.`; }, 
        explanation_hi: (ans) => { return `कृपया अपना ${ans.id_type_update || 'ID'} नंबर स्पष्ट रूप से दर्ज करें।`; },
        type: 'text', validation: 'required', 
        condition: (ans) => ans.app_type && ans.app_type.toLowerCase() === 'update' 
      },
      { 
      ...
      { 
        ...
        label_en: 'Full Name', 
        label_hi: 'पूरा नाम', 
        explanation_en: 'Please enter your full legal name as per your documents.', 
        explanation_hi: 'कृपया अपने दस्तावेज़ों के अनुसार अपना पूरा कानूनी नाम दर्ज करें।',
        type: 'text', validation: 'name_required' 
      },
      { 
        id: 'gender', 
        label_en: 'Gender (Male/Female/Transgender)', 
        label_hi: 'लिंग (पुरुष/महिला/ट्रांसजेंडर)', 
        explanation_en: 'Please type your gender.', 
        explanation_hi: 'कृपया अपना लिंग टाइप करें।',
        type: 'text', validation: 'required' 
      },
      { 
        id: 'age_group', 
      ...
      { 
        id: 'age_or_dob', 
        label_en: 'Enter exact Date of Birth (DD/MM/YYYY)', 
        label_hi: 'सटीक जन्मतिथि दर्ज करें (DD/MM/YYYY)', 
        explanation_en: 'Tell me your exact date of birth.', 
        explanation_hi: 'मुझे अपनी सटीक जन्मतिथि बताएं।',
        type: 'text', validation: 'required' 
      },
      { 
      ...
      { 
        id: 'has_co', 
        label_en: 'Do you want to add a Care of (C/O) name in the address? (Yes/No)', 
        label_hi: 'क्या आप पते में केयर ऑफ (C/O) नाम जोड़ना चाहते हैं? (हाँ/नहीं)', 
        explanation_en: "If you live at someone else's house or have a caretaker, type 'Yes'.", 
        explanation_hi: "यदि आप किसी और के घर में रहते हैं या देखभाल करने वाला है, तो 'हाँ' लिखें।",
        type: 'text', validation: 'required' 
      },
      { 
        id: 'address_co', 
        label_en: 'Address: C/o Name', 
        label_hi: 'पता: द्वारा (C/o) नाम', 
        explanation_en: "Please type the 'Care of' name.", 
        explanation_hi: "कृपया 'केयर ऑफ' नाम टाइप करें।",
        type: 'text', validation: 'required', 
        condition: (ans) => ans.has_co && ans.has_co.toLowerCase() === 'yes' 
      },
      { 
        id: 'address_house', 
        label_en: 'House No./ Bldg./ Apt:', 
        label_hi: 'मकान नंबर / बिल्डिंग / अपार्टमेंट', 
        explanation_en: 'What is your house number or apartment name?', 
        explanation_hi: 'आपका मकान नंबर या अपार्टमेंट का नाम क्या है?',
        type: 'text', validation: 'required' 
      },
      { 
        id: 'address_area', 
        label_en: 'Area/ Locality/ Sector:', 
        label_hi: 'क्षेत्र/इलाका/सेक्टर', 
        explanation_en: 'Which area or sector is your house located in?', 
        explanation_hi: 'आपका घर किस क्षेत्र या सेक्टर में स्थित है?',
        type: 'text', validation: 'required' 
      },
      { 
        id: 'address_village', 
        label_en: 'Village/ Town/ City:', 
        label_hi: 'गांव/कस्बा/शहर', 
        explanation_en: 'What is the name of your village, town, or city?', 
        explanation_hi: 'आपके गांव, कस्बे या शहर का नाम क्या है?',
        type: 'text', validation: 'required' 
      },
      { 
        id: 'address_district', 
        label_en: 'District:', 
        label_hi: 'ज़िला', 
        explanation_en: 'Which district do you belong to?', 
        explanation_hi: 'आप किस जिले से हैं?',
        type: 'text', validation: 'required' 
      },
      { 
        id: 'address_state', 
        label_en: 'State:', 
        label_hi: 'राज्य', 
        explanation_en: 'In which state do you currently reside?', 
        explanation_hi: 'आप वर्तमान में किस राज्य में रहते हैं?',
        type: 'text', validation: 'required' 
      },
      { 
        id: 'email', 
        label_en: 'E-Mail:', 
        label_hi: 'ई-मेल', 
        explanation_en: 'Provide your email address if you want it linked.', 
        explanation_hi: 'यदि आप लिंक करना चाहते हैं तो अपना ईमेल पता प्रदान करें।',
      ...
      { 
        ...
        explanation_en: 'Provide a 10-digit mobile number for OTP and updates.', 
        explanation_hi: 'ओटीपी और अपडेट के लिए 10 अंकों का मोबाइल नंबर प्रदान करें।',
        type: 'number', validation: 'mobile' 
      },
      { 
        id: 'pin_code', 
        label_en: 'PIN Code:', 
        label_hi: 'पिन कोड', 
        explanation_en: 'Enter your 6-digit area PIN Code.', 
        explanation_hi: 'अपना 6 अंकों का एरिया पिन कोड दर्ज करें।',
        type: 'number', validation: 'pincode' 
      },
      { 
      ...
      { 
        id: 'relative_name', 
        label_en: 'Relative\'s Name:', 
        label_hi: 'रिश्तेदार का नाम', 
        explanation_en: "What is their exact name?", 
        explanation_hi: "उनका पूरा नाम क्या है?",
        type: 'text', validation: 'required',
        condition: (ans) => ans.relative_details_type && ans.relative_details_type.toLowerCase() !== 'no' && ans.relative_details_type.toLowerCase() !== 'नहीं'
      },
      { 
        id: 'relative_aadhaar', 
      ...
      { 
        ...
        type: 'text', validation: 'required',
        condition: (ans) => ans.verification_type && ans.verification_type.toLowerCase().includes('document') && ans.dob_declared_verified && ans.dob_declared_verified.toLowerCase() === 'verified'
      },
      { 
        id: 'por_doc', 
  ...
  withdrawal: {
    ...
    fields: [
      { id: 'post_office_name', label_en: 'Name of the Post Office', label_hi: 'डाकघर का नाम', explanation_en: 'At which post office branch do you hold the account?', explanation_hi: 'आपका खात किस डाकघर शाखा में है?', type: 'text', validation: 'required' },
